create table logs.cp_queuement_changes(
assignment_id bigint primary key,
created_at timestamp with time zone);
ALTER TABLE logs.cp_queuement_changes OWNER TO dev_rppj;
...
ALTER FUNCTION  logs.log_cp_queue_changes() OWNER TO dev_rppj;

CREATE TRIGGER after_cp_queue_assignment_change
AFTER INSERT OR UPDATE ON cp_queue_assignments
FOR EACH ROW
EXECUTE FUNCTION logs.log_cp_queue_changes();

ALTER TABLE cp_queue_assignments OWNER TO postgres;
